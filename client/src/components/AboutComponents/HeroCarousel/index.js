            ...
            <div id="carouselExampleFade" className="carousel slide carousel-fade" data-ride="carousel">
                <div className="carousel-inner">
                    ...
                    <div className="carousel-item">
                        ...
                        <img className="d-block w-100" src='/images/City-04.jpg' alt="Second slide" />
                    ...
                    <div className="carousel-item ">
                        <img className="d-block w-100" src='/images/Barber-02.jpg' alt="First slide" />
                        <div className="carousel-caption d-none d-md-block">
                    ...
                    <div className="carousel-item active">
                        <img className="d-block w-100" src='/images/Barber-04.jpg' src1={props.SliderImage3} alt="Third slide" />
                        <div className="carousel-caption d-none d-md-block">
